...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_12__["default"])(C_login, _Component);
  ...
  function C_login() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_7__["default"])(this, C_login);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_9__["default"])(this, (_getPrototypeOf2 = Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_10__["default"])(C_login)).call.apply(_getPrototypeOf2, [this].concat(args)));

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_11__["default"])(_this), "Login", function () {
      antd_lib_message__WEBPACK_IMPORTED_MODULE_6___default.a.loading('...');
      ...
      new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_5___default.a(function (resolve, reject) {
        resolve(Object(_apis_datas__WEBPACK_IMPORTED_MODULE_16__["Login"])(user, password));
      }).then(function (res) {
        console.log(res);

        if (res === false) {
          antd_lib_message__WEBPACK_IMPORTED_MODULE_6___default.a.loading("ลงชื่อเข้าใช้งาน....", 2).then(function () {
            return antd_lib_message__WEBPACK_IMPORTED_MODULE_6___default.a.error("ไม่พบEmail & Password");
          });
        } else {
          antd_lib_message__WEBPACK_IMPORTED_MODULE_6___default.a.loading("ลงชื่อเข้าใช้งาน....", 2).then(function () {
            antd_lib_message__WEBPACK_IMPORTED_MODULE_6___default.a.success("ลงชื่อเข้าใช้งาน", 3).then(function () {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_11__["default"])(_this), "Regiter", function () {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_8__["default"])(C_login, [{
    key: "render",
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_cookie__WEBPACK_IMPORTED_MODULE_15__["withCookies"])(C_login));

/***/ })

})
//# sourceMappingURL=login.js.ca2b1b3a94ce113f11cf.hot-update.js.map