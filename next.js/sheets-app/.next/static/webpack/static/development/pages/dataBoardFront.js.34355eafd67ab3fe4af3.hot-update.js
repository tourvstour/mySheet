...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_7__["default"])(databoard, _Component);
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(databoard, [{
    ...
    value: function componentDidMount() {
      ...
      new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_2___default.a(function (resolve, reject) {
        var orders = Object(_apis_datas__WEBPACK_IMPORTED_MODULE_9__["AllOrders"])(user);
        resolve(orders);
      }).then(function (res) {
        var AllOdersRow = res.length;
        var totalMonney = null;
        res.forEach(function (v) {
          totalMonney = +totalMonney + +v.cod_waiting_list_sent_amount;
          return totalMonney;
        });
      ...
      new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_2___default.a(function (resolve, reject) {
        var waitingOrder = Object(_apis_datas__WEBPACK_IMPORTED_MODULE_9__["WaitingOrders"])(user);
      ...
      new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_2___default.a(function (resolve, reject) {
        var paybackorder = Object(_apis_datas__WEBPACK_IMPORTED_MODULE_9__["PayBackOrders"])(user);
        resolve(paybackorder);
      }).then(function (res) {
        var PayBackRow = res.length;
        var totalMonney = null;
        res.forEach(function (v) {
          totalMonney = +totalMonney + +v.cod_pay_back_sent_amount;
        });
      ...
      new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_2___default.a(function (resolve, reject) {
        var excess = Object(_apis_datas__WEBPACK_IMPORTED_MODULE_9__["Excess"])(user);
        resolve(excess);
      }).then(function (res) {
      ...
      new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_2___default.a(function (resolve, rejects) {
        var absent = Object(_apis_datas__WEBPACK_IMPORTED_MODULE_9__["Absent"])(user);
        resolve(absent);
      }).then(function (res) {
    ...
    value: function render() {
      return __jsx("div", {
        ...
        columns: columns,
        dataSource: this.state.AllOdersData,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 154
        },
...
var columns = [{
  title: 'วันที่',
  dataIndex: 'cod_waiting_list_date_transport',
  key: 'cod_waiting_list_date_transport'
}, {
  title: 'เลขพัสดุ',
  dataIndex: 'number',
  key: 'number'
...
//# sourceMappingURL=dataBoardFront.js.34355eafd67ab3fe4af3.hot-update.js.map