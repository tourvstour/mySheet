...
function (_Component) {
  ...
  function C_login() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_11__["default"])(_this), "Login", function () {
      ...
      new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_6___default.a(function (resolve, reject) {
        resolve(Object(_apis_datas__WEBPACK_IMPORTED_MODULE_16__["Login"])(user, password));
      }).then(function (res) {
        //console.log(res)
        if (res === false) {
          antd_lib_message__WEBPACK_IMPORTED_MODULE_5___default.a.loading("ลงชื่อเข้าใช้งาน....", 2).then(function () {
            return antd_lib_message__WEBPACK_IMPORTED_MODULE_5___default.a.error("ไม่พบEmail & Password");
          });
        } else {
          antd_lib_message__WEBPACK_IMPORTED_MODULE_5___default.a.loading("ลงชื่อเข้าใช้งาน....", 2).then(function () {
            antd_lib_message__WEBPACK_IMPORTED_MODULE_5___default.a.success("ลงชื่อเข้าใช้งาน", 3).then(function () {
...
//# sourceMappingURL=login.js.c21adfd4f5ef810714be.hot-update.js.map