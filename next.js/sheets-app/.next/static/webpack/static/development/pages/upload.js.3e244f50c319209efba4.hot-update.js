...
function (_React$Component) {
  ...
  function Table(props) {
    ...
    _this.renderTable = function (_ref2) {
      ...
      var classString = (0, _classnames["default"])((_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefixCls, "-").concat(_this.props.size), true), _defineProperty(_classNames2, "".concat(prefixCls, "-bordered"), _this.props.bordered), _defineProperty(_classNames2, "".concat(prefixCls, "-empty"), !data.length), _defineProperty(_classNames2, "".concat(prefixCls, "-without-column-header"), !showHeader), _classNames2));
  ...
  _createClass(Table, [{
    ...
    value: function toggleSortOrder(column) {
      ...
      if (onChange) {
        onChange.apply(null, this.prepareParamsArguments(_extends(_extends({}, this.state), newState)));
      }
    }
  }, {
    key: "hasPagination",
    ...
    value: function createComponents() {
      ...
      this.components = _extends(_extends({}, components), {
  ...
  _createClass(FilterMenu, [{
    ...
    value: function render() {
      ...
      var _this$props3 = this.props,
          ...
          getPopupContainer = _this$props3.getPopupContainer; // default multiple selection in filter dropdown
...
function ColGroup(props, _ref) {
  ...
  if (expandIconAsCell && fixed !== 'right') {
    cols.push(react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement('col', { className: prefixCls + '-expand-icon-col', key: 'rc-table-expand-icon-col' }));
  }
  ...
  cols = cols.concat(leafColumns.map(function (_ref2) {
    var key = _ref2.key,
        ...
        width = _ref2.width,
        additionalProps = _ref2[_utils__WEBPACK_IMPORTED_MODULE_3__["INTERNAL_COL_DEFINE"]];

    var mergedKey = key !== undefined ? key : dataIndex;
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement('col', babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({ key: mergedKey, style: { width: width, minWidth: width } }, additionalProps));
  }));
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils */ "./node_modules/rc-table/es/utils.js");
/* harmony import */ var _BaseTable__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./BaseTable */ "./node_modules/rc-table/es/BaseTable.js");
...
function HeadTable(props, _ref) {
  ...
  var headStyle = {};
  var scrollbarWidth = Object(_utils__WEBPACK_IMPORTED_MODULE_4__["measureScrollbar"])({ direction: 'vertical' });

  if (scroll.y) {
    useFixedHeader = true;
    // https://github.com/ant-design/ant-design/issues/17051
    var scrollbarWidthOfHeader = Object(_utils__WEBPACK_IMPORTED_MODULE_4__["measureScrollbar"])({ direction: 'horizontal', prefixCls: prefixCls });
    // Add negative margin bottom for scroll bar overflow bug
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(
    'div',
    {
      ...
      className: classnames__WEBPACK_IMPORTED_MODULE_3___default()(prefixCls + '-header', babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, prefixCls + '-hide-scrollbar', scrollbarWidth > 0)),
      style: headStyle,
      onScroll: handleBodyScrollLeft
    },
    react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_BaseTable__WEBPACK_IMPORTED_MODULE_5__["default"], {
      tableClassName: tableClassName,
      hasHead: true,
      hasBody: false,
      fixed: fixed,
...
HeadTable.propTypes = {
  ...
  columns: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.array.isRequired,
  tableClassName: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.string.isRequired,
  handleBodyScrollLeft: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.func.isRequired,
  expander: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.object.isRequired
};
...
/*!*******************************************!*\
  !*** ./node_modules/rc-table/es/utils.js ***!
  \*******************************************/
/*! exports provided: INTERNAL_COL_DEFINE, measureScrollbar, debounce, warningOnce, remove, getDataAndAriaProps */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
//# sourceMappingURL=upload.js.3e244f50c319209efba4.hot-update.js.map